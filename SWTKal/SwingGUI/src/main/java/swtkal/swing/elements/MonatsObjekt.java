...
// XXX Farbkodierungen evtl. an eine zentrale Stelle verschieben?	
   static final Color HEADING_BACKGRD = Color.gray;                 // new Color(128, 255, 128);   // �berschrift
   ...
   static final Color FEIERTAG_FOREGRD = Color.red;                 // Feiertag
	...
	private JPanel createMtSelect(int mt, int yr) throws IOException {
		JPanel selectMonth = new JPanel();
		selectMonth.setLayout(new BoxLayout(selectMonth, BoxLayout.X_AXIS));

		JButton b1 = new JButton(new ImageIcon(ImageIO.read(Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("images/left.gif")))));
		b1.setMargin(new Insets(0, 0, 0, 0));
		b1.setAlignmentY((float) 0.5);
		b1.setRolloverEnabled(true);
		b1.setRolloverIcon(new ImageIcon(ImageIO.read(Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("images/leftRollover.gif")))));
		b1.setActionCommand("previousMonth");
		b1.addActionListener(this);

		JButton b2 = new JButton(new ImageIcon(ImageIO.read(Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("images/right.gif")))));
		b2.setMargin(new Insets(0, 0, 0, 0));
		b2.setAlignmentY((float) 0.5);
		b2.setRolloverEnabled(true);
		b2.setRolloverIcon(new ImageIcon(ImageIO.read(Objects.requireNonNull(getClass().getClassLoader().getResourceAsStream("images/rightRollover.gif")))));
